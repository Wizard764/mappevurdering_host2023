...
public class TrainDepartureRegistryTest {
  ...
  @Test
  public void testGetHighestTrackNo() {
    TrainDepartureRegistry tdr = new TrainDepartureRegistry();
    tdr.addDeparture(new TrainDeparture(LocalTime.of(12, 31), "F4", "AR762", "Trondheim", (short) 1));
    tdr.addDeparture(new TrainDeparture(LocalTime.of(8, 15), "A1", "AR123", "Oslo", (short) 3));
    tdr.addDeparture(new TrainDeparture(LocalTime.of(9, 45), "B2", "AR456", "Trondheim", (short) 5));
    tdr.addDeparture(new TrainDeparture(LocalTime.of(11, 20), "C3", "AR789", "Stavanger",(short) 2));
    tdr.addDeparture(new TrainDeparture(LocalTime.of(13, 0), "D4", "AR101", "Kristiansand", (short) 2));
    tdr.addDeparture(new TrainDeparture(LocalTime.of(19, 15), "H8", "AR111", "Trondheim", (short) -1));
    tdr.addDeparture(new TrainDeparture(LocalTime.of(20, 50), "I9", "AR222", "Trondheim", (short) 5));
    tdr.addDeparture(new TrainDeparture(LocalTime.of(14, 30), "E5", "AR234", "Drammen", LocalTime.of(1, 40)));
    tdr.addDeparture(new TrainDeparture(LocalTime.of(16, 5), "F6", "AR567", "Molde", (short) 1));
    tdr.addDeparture(new TrainDeparture(LocalTime.of(17, 40), "G7", "AR890", "Alesund"));
    tdr.addDeparture(new TrainDeparture(LocalTime.of(22, 25), "J10", "AR333", "Bodø"));

    assert(tdr.getHighestTrackNo() == 5);
  }
}